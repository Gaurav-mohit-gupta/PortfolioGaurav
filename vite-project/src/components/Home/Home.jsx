...
import GauravImage from "../../assets/mohit.jpeg";
...
const Home = () => {
    ...
    return (
        ...
        >
            <div
            className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 sm:pt-28 pb-12 sm:pb-16 md:pb-24">
                <div 
                className="grid grid-cols-1 md:grid-cols-2 gap-10 lg:gap-16 items-start pt-14">
                    ...
                    className="flex flex-col justify-center text-center md:text-left">
                        ...
                        <p className={`text-lg sm:text-xl md:text-2xl font-semibold mb-6 ${textSecondary}`} >
                            Full Stack Developer | DSA In JAVA
                        </p>

                        <p  className={`text-base sm:text-lg leading-relaxed mb-8 ${textPrimary}`}>
                            specialized in the {" "}
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                            <Link to="/work">
                            <button className={`px-8 py-3 rounded-lg font-semibold transition-all duration-300 text-sm sm:text-base cursor-pointer ${
                                isDark
                            ...
                            <Link to="/contact">
                            <button className={`px-8 py-3 rounded-lg font-semibold border-2 transition-all duration-300 text-sm sm:text-base cursor-pointer ${
                                isDark 
                    ...
                    <div className="flex flex-col items-center gap-8">
                        <div className={`relative w-48 h-48 sm:w-64 sm:h-64 md:w-72 md:h-72 lg:w-80 lg:h-80 rounded-2xl overflow-hidden border-4 ${
                        ...
                        return (
                            ...
                            >
                                ...
                                <div>
                                    ...
                                    <p className={`text-sm sm:text-base ${textPrimary} leading-snug`}
                                    >
                                        {role.desc}
                                    </p>
                                </div>
