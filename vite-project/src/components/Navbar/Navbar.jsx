...
export default function Navbar() {
    ...
    const navbarBg =
    theme === "dark" ? "bg-black border-b border-blue-900/40"
            ...
            <motion.div
               ...
               whileTap={{ scale: 0.95 }}
                ...
                >
                    ...
                    <div className="w-8 h-8 rounded-lg bg-liner-to-br from-blue-500 to-blue-600 flex items-center justify-center text-white font-bold group-hover:shadow-lg group-hover:shadow-blue-500/50 transition-all duration-300 ">
                    G
            
                    </div>
                    <span className={`text-base sm:text-lg font-bold bg-clip-text bg-liner-to-r from-blue-700 text-transparent hidden sm:inline group-hover:opacity-80 transition-opacity `}
                    >
                        Portfolio
                    </span>
                    </NavLink>
