  ...
  const SkillBar = ({ skill, delay }) => {
    ...
    return (
      <div className="mb-4 group">
        ...
        >
          <div
            className="h-2.5 bg-liner-to-r from-blue-500 to-blue-600 rounded-full transition-all duration-1000 ease-out"
  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto">
        ...
        >
          <h1 className="text-5xl md:text-6xl font-bold bg-liner-to-r from-blue-500 to-blue-600 bg-clip-text text-transparent [text-fill-color:transparent] mb-4 leading-snug overflow-visible pb-1 pt-4">
            My Skills
          </h1>

          <div className="w-24 h-1 bg-liner-to-r from-blue-500 to-blue-600 mx-auto rounded-full mb-6"></div>
        ...
        >
          ...
          <div
            className={`text-center ${cardBg} rounded-2xl p-6 border-2 transition-all duration-300 hover:-translate-y-2`}
          >
            <div className={`text-3xl font-bold ${textSecondary} mb-2`}>0+</div>
            <div className={`text-sm font-medium ${textPrimary}`}>
              Years Experience
            </div> 
          </div>
