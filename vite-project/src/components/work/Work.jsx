...
const Work = () => {
  ...
  return (
    ...
    >
      <div className="absolute inset-0 pointer-events-none bg-liner-to-br from-blue-50/20 via-transparent to-blue-100/10"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 pt-4">
        <div className="text-center mb-16">
          ...
          <div className="w-16 h-1 bg-liner-to-r from-blue-500 to-blue-600 mx-auto rounded-full"></div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project, index) => (
            ...
            >
              <div className="relative h-56 overflow-hidden bg-liner-to-b from-blue-500/10 to-transparent">
                <img
                  src={project.img}
                  alt={project.title}
